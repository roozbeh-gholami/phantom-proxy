...
echo ""
print_warn "IMPORTANT: Configure iptables to prevent kernel interference!"
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Configure iptables (commands above)"
echo "  2. Review the configuration: cat $CONFIG_FILE"
echo "  3. Run phantom-proxy: sudo phantom-proxy run -c $CONFIG_FILE"
echo ""
